...
class CachedAuthorDaoSpec: QuickSpec {
    
    override func spec() {
        
        var authorDatabase: Realm!
        var cachedAuthorDao: CachedAuthorDao!
        ...
        beforeEach {
            ...
            cachedAuthorDao = CachedAuthorDaoImpl()
        ...
        describe("Find Author by idAuthor") {
            context("Found") {
                it("Author is returned") {
                    ...
                    expect { try cachedAuthorDao.findAuthor(byIdAuthor: firstAuthor.idAuthor).waitingCompletion().first }.to(equal(firstAuthor))
                }
            }
            ...
            context("Not Found") {
                it("Error is thrown") {
                    ...
                    expect { try cachedAuthorDao.findAuthor(byIdAuthor: firstAuthor.idAuthor).waitingCompletion().first }.to(throwError())
                }
            }
        }
        ...
        describe("Find Authors by name") {
            context("Found") {
                it("Authors are returned") {
                    ...
                    expect { try cachedAuthorDao.findAuthors(byName: firstAuthor.name).waitingCompletion().first }.to(equal([firstAuthor, secondAuthor]))
                }
            }
            ...
            context("Not Found") {
                it("Error is thrown") {
                    ...
                    expect { try cachedAuthorDao.findAuthors(byName: firstAuthor.name).waitingCompletion().first }.to(throwError())
                }
            }
        }
        ...
        describe("Find Authors by idMovement") {
            context("Found") {
                it("Authors are returned") {
                    ...
                    expect { try cachedAuthorDao.findAuthors(byIdMovement: movement.idMovement).waitingCompletion().first }.to(equal([firstAuthor, secondAuthor]))
                }
            }
            ...
            context("Not Found") {
                it("Error is thrown") {
                    ...
                    expect { try cachedAuthorDao.findAuthors(byIdMovement: thirdAuthor.idMovement!).waitingCompletion().first }.to(throwError())
                }
            }
        }
        ...
        describe("Find Authors by idTheme") {
            context("Found") {
                it("Authors are returned") {
                    ...
                    expect { try cachedAuthorDao.findAuthors(byIdTheme: theme.idTheme).waitingCompletion().first }.to(equal([firstAuthor, secondAuthor]))
                }
            }
            ...
            context("Not Found") {
                it("Error is thrown") {
                    ...
                    expect { try cachedAuthorDao.findAuthors(byIdTheme: secondTheme.idTheme).waitingCompletion().first }.to(throwError())
                }
            }
        }
        ...
        describe("Find Author by idPresentation") {
            context("Found") {
                it("Author is returned") {
                    ...
                    expect { try cachedAuthorDao.findAuthor(byIdPresentation: presentation.idPresentation).waitingCompletion().first }.to(equal(firstAuthor))
                }
            }
            ...
            context("Not Found") {
                it("Error is thrown") {
                    ...
                    expect { try cachedAuthorDao.findAuthor(byIdPresentation: presentation.idPresentation).waitingCompletion().first }.to(throwError())
                }
            }
        }
        ...
        describe("Find Author by idPicture") {
            context("Found") {
                it("Author is returned") {
                    ...
                    expect { try cachedAuthorDao.findAuthor(byIdPicture: picture.idPicture).waitingCompletion().first }.to(equal(firstAuthor))
                }
            }
            ...
            context("Not Found") {
                it("Error is thrown") {
                    ...
                    expect { try cachedAuthorDao.findAuthor(byIdPicture: picture.idPicture).waitingCompletion().first }.to(throwError())
                }
            }
        }
        ...
        describe("Find all Authors") {
            context("Found") {
                it("All Authors are returned") {
                    ...
                    expect { try cachedAuthorDao.findAllAuthors().waitingCompletion().first }.to(equal([firstAuthor, secondAuthor, thirdAuthor]))
                }
            }
            
            context("Database Empty") {
                it("Error is thrown") {
                    expect { try cachedAuthorDao.findAllAuthors().waitingCompletion().first }.to(throwError())
                }
            }
        }
    }
