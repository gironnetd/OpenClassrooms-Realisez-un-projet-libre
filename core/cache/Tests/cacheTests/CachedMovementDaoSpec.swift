...
class CachedMovementDaoSpec: QuickSpec {
    
    override func spec() {
      
        var movementDatabase : Realm!
        var cachedMovementDao : CachedMovementDao!
        ...
        beforeEach {
            ...
            cachedMovementDao = CachedMovementDaoImpl()
            ...
            describe("Find Movement by idMovement") {
                context("Found") {
                    it("Movement is returned") {
                        ...
                        expect { try cachedMovementDao.findMovement(byIdMovement: firstMovement.idMovement).waitingCompletion().first }.to(equal(firstMovement))
                    }
                }
                ...
                context("Not Found") {
                    it("Error is thrown") {
                        ...
                        expect { try cachedMovementDao.findMovement(byIdMovement: firstMovement.idMovement).waitingCompletion().first }.to(throwError())
                    }
                }
            }
        ...
        describe("Find movements by name") {
            context("Found") {
                it("Movements are returned") {
                    ...
                    expect { try cachedMovementDao.findMovements(byName: firstMovement.name).waitingCompletion().first }.to(equal([firstMovement, secondMovement]))
                }
            }
            ...
            context("Not Found") {
                it("Error is thrown") {
                    ...
                    expect { try cachedMovementDao.findMovements(byName: DataFactory.randomString()).waitingCompletion().first }.to(throwError())
                }
            }
        }
        ...
        describe("Find Movements by idParent") {
            context("Found") {
                it("Movements are returned") {
                    ...
                    expect { try cachedMovementDao.findMovements(byIdParent: firstMovement.idMovement).waitingCompletion().first }.to(equal([secondMovement, thirdMovement]))
                }
            }
            ...
            context("Not Found") {
                it("Error is thrown") {
                    ...
                    expect { try cachedMovementDao.findMovements(byIdParent: DataFactory.randomInt()).waitingCompletion().first }.to(throwError())
                }
            }
        }
        ...
        describe("Find Main Movements") {
            context("Found") {
                it("Main movements are returned") {
                    ...
                    expect { try cachedMovementDao.findMainMovements().waitingCompletion().first }.to(equal([firstMovement, secondMovement]))
                }
            }
            ...
            context("Not Found") {
                it("Error is thrown") {
                    ...
                    expect { try cachedMovementDao.findMainMovements().waitingCompletion().first }.to(throwError())
                }
            }
        }
        ...
        describe("Find all Movements") {
            context("Found") {
                it("All Movements are returned") {
                    ...
                    expect { try cachedMovementDao.findAllMovements().waitingCompletion().first }.to(equal([firstMovement, secondMovement, thirdMovement]))
                }
            }
            
            context("Database Empty") {
                it("Error is thrown") {
                    expect { try cachedMovementDao.findAllMovements().waitingCompletion().first }.to(throwError())
                }
            }
        }
    }
