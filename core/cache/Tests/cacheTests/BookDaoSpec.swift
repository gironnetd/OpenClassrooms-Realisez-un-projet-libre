        ...
        describe("Find Book by idBook") {
            context("Found") {
                it("Book is returned") {
                    ...
                    expect { try bookDao.findBook(byIdBook: firstBook.idBook).waitingCompletion().first }.to(equal(firstBook))
                }
            }
            ...
            context("Not Found") {
                it("Error is thrown") {
                    ...
                    expect { try bookDao.findBook(byIdBook: firstBook.idBook).waitingCompletion().first }.to(throwError())
                }
            }
        }
        ...
        describe("Find all Books") {
            context("Found") {
                it("All Books are returned") {
                    ...
                    expect { try bookDao.findAllBooks().waitingCompletion().first }.to(equal([firstBook, secondBook, thirdBook]))
                }
            }
