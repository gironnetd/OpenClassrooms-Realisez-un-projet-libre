 ...
 */
public class PresentationDaoImpl : PresentationDao {
    ...
    public func findPresentation(byIdPresentation idPresentation: Int) -> Future<CachedPresentation, Error> {
        Future { promise in
    ...
    ///
    /// - Returns: A Future returning a CachedPresentation or an Error
    public func findPresentation(byIdAuthor idAuthor: Int) -> Future<CachedPresentation, Error> {
        Future { promise in
    ...
    ///
    /// - Returns: A Future returning a CachedPresentation or an Error
    public func findPresentation(byIdBook idBook: Int) -> Future<CachedPresentation, Error> {
        Future { promise in
    ...
    ///
    /// - Returns: A Future returning a CachedPresentation or an Error
    public func findPresentation(byIdMovement idMovement: Int) -> Future<CachedPresentation, Error> {
        Future { promise in
    ...
    public func findAllPresentations() -> Future<[CachedPresentation], Error> {
        Future { promise in
            guard let presentations = Optional(self.realm.objects(CachedPresentation.self)), !presentations.isEmpty else {
                return promise(.failure(Realm.Error(Realm.Error.fail)))
            }
