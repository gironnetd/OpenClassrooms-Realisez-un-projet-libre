 ...
 */
public class CenturyDaoImpl : CenturyDao {
    ...
    public func findCentury(byIdCentury idCentury: Int) -> Future<CachedCentury, Error> {
        Future { promise in
    ...
    ///
    /// - Returns: A Future returning a CachedCentury or an Error
    public func findCentury(byIdAuthor idAuthor: Int) -> Future<CachedCentury, Error> {
        Future { promise in
    ...
    ///
    /// - Returns: A Future returning a CachedCentury or an Error
    public func findCentury(byIdBook idBook: Int) -> Future<CachedCentury, Error> {
        Future { promise in
    ...
    public func findAllCenturies() -> Future<[CachedCentury], Error> {
        Future { promise in
            guard let centuries = Optional(self.realm.objects(CachedCentury.self)), !centuries.isEmpty else {
                return promise(.failure(Realm.Error.init(Realm.Error.fail)))
            }
