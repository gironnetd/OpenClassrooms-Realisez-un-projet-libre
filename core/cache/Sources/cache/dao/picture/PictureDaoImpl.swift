 ...
 */
public class PictureDaoImpl : PictureDao {
    ...
    public func findPicture(byIdPicture idPicture: Int) -> Future<CachedPicture, Error> {
        Future { promise in
    ...
    ///
    /// - Returns: A Future returning an Array of CachedPicture or an Error
    public func findPictures(byIdAuthor idAuthor: Int) -> Future<[CachedPicture], Error> {
        Future { promise in
    ...
    ///
    /// - Returns: A Future returning an Array of CachedPicture or an Error
    public func findPictures(byIdBook idBook: Int) -> Future<[CachedPicture], Error> {
        Future { promise in
    ...
    ///
    /// - Returns: A Future returning an Array of CachedPicture or an Error
    public func findPictures(byIdMovement idMovement: Int) -> Future<[CachedPicture], Error> {
        Future { promise in
    ...
    ///
    /// - Returns: A Future returning an Array of CachedPicture or an Error
    public func findPictures(byIdTheme idTheme: Int) -> Future<[CachedPicture], Error> {
        Future { promise in
    ...
    public func findAllPictures() -> Future<[CachedPicture], Error> {
        Future { promise in
            guard let pictures = Optional(self.realm.objects(CachedPicture.self)), !pictures.isEmpty else {
                return promise(.failure(Realm.Error(Realm.Error.fail)))
            }
            promise(.success(pictures.toArray()))
        }
