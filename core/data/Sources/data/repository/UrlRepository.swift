...
public protocol UrlRepository {
    ...
    func findUrl(byIdUrl idUrl : Int) -> AnyPublisher<Url, Error>
    ...
    func findUrls(byIdAuthor idAuthor: Int) -> AnyPublisher<[Url], Error>
    ...
    ///
    /// - Returns: An AnyPublisher returning an Array of Url or an Error
    func findUrls(byIdBook idBook: Int) -> AnyPublisher<[Url], Error>
    ...
    ///
    /// - Returns: An AnyPublisher returning an Array of Url or an Error
    func findUrls(byIdMovement idMovement: Int) -> AnyPublisher<[Url], Error>
    ...
    ///
    /// - Returns: An AnyPublisher returning an Array of Url or an Error
    func findUrls(byIdSource idSource: Int, sourceType: String) -> AnyPublisher<[Url], Error>
    ...
    ///
    /// - Returns: An AnyPublisher returning an Array of Url or an Error
    func findUrls(bySourceType sourceType: String) -> AnyPublisher<[Url], Error>
