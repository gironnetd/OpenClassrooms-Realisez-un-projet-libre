...
public protocol QuoteRepository {
    ...
    func findQuote(byIdQuote idQuote: Int) -> AnyPublisher<Quote, Error>
    ...
    func findQuotes(byIdAuthor idAuthor: Int) -> AnyPublisher<[Quote], Error>
    ...
    ///
    /// - Returns: An AnyPublisher returning an Array of Quote or an Error
    func findQuotes(byIdBook idBook: Int) -> AnyPublisher<[Quote], Error>
    ...
    ///
    /// - Returns: An AnyPublisher returning an Array of Quote or an Error
    func findQuotes(byIdMovement idMovement: Int) -> AnyPublisher<[Quote], Error>
    ...
    ///
    /// - Returns: An AnyPublisher returning an Array of Quote or an Error
    func findQuotes(byIdTheme idTheme: Int) -> AnyPublisher<[Quote], Error>
