...
public protocol AuthorRepository {
    ...
    func findAuthor(byIdAuthor idAuthor: Int) -> AnyPublisher<Author, Error>
    ...
    ///
    /// - Returns: An AnyPublisher returning an Array of Author or an Error
    func findAuthors(byIdMovement idMovement: Int) -> AnyPublisher<[Author], Error>
    ...
    ///
    /// - Returns: An AnyPublisher returning an Array of Author or an Error
    func findAuthors(byIdTheme idTheme: Int) -> AnyPublisher<[Author], Error>
    ...
    ///
    /// - Returns: An AnyPublisher returning an Author or an Error
    func findAuthor(byIdPresentation idPresentation: Int) -> AnyPublisher<Author, Error>
    ...
    ///
    /// - Returns: An AnyPublisher returning an Author or an Error
    func findAuthor(byIdPicture idPicture: Int) -> AnyPublisher<Author, Error>
