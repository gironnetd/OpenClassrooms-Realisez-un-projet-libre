...
public class BookRepositoryImpl: BookRepository {
    ...
    public func findBook(byIdBook idBook: Int) -> AnyPublisher<Book, Error> {
        bookDao.findBook(byIdBook: idBook).map { book in book.asExternalModel() }.eraseToAnyPublisher()
    }
    ...
    public func findBooks(byName name: String) -> AnyPublisher<[Book], Error> {
        bookDao.findBooks(byName: name).map { books in
    ...
    ///
    /// - Returns: An AnyPublisher returning an Array of Book or an Error
    public func findBooks(byIdMovement idMovement: Int) -> AnyPublisher<[Book], Error> {
        bookDao.findBooks(byIdMovement: idMovement).map { books in
            books.map { book in book.asExternalModel() }
        }.eraseToAnyPublisher()
    }
    ...
    ///
    /// - Returns: An AnyPublisher returning an Array of Book or an Error
    public func findBooks(byIdTheme idTheme: Int) -> AnyPublisher<[Book], Error> {
        bookDao.findBooks(byIdTheme: idTheme).map { books in
            books.map { book in book.asExternalModel() }
        }.eraseToAnyPublisher()
    }
    ...
    ///
    /// - Returns: An AnyPublisher returning a Book or an Error
    public func findBook(byIdPresentation idPresentation: Int) -> AnyPublisher<Book, Error> {
        bookDao.findBook(byIdPresentation: idPresentation).map { book in book.asExternalModel() }.eraseToAnyPublisher()
    }
    ...
    ///
    /// - Returns: An AnyPublisher returning a Book or an Error
    public func findBook(byIdPicture idPicture: Int) -> AnyPublisher<Book, Error> {
        bookDao.findBook(byIdPicture: idPicture).map { book in book.asExternalModel() }.eraseToAnyPublisher()
    }
    ...
    public func findAllBooks() -> AnyPublisher<[Book], Error> {
        bookDao.findAllBooks().map { books in
            books.map { book in book.asExternalModel() }
        }.eraseToAnyPublisher()
    }
}
