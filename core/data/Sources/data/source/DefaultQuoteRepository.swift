...
public class DefaultQuoteRepository: QuoteRepository {
    ...
    public func findQuote(byIdQuote idQuote: Int) -> AnyPublisher<Quote, Error> {
        self.quoteDao.findQuote(byIdQuote: idQuote).map { quote in quote.asExternalModel() }.eraseToAnyPublisher()
    }
    ...
    public func findAllQuotes() -> AnyPublisher<[Quote], Error> {
        self.quoteDao.findAllQuotes().map { quotes in
            quotes.map { quote in quote.asExternalModel() }
        }.eraseToAnyPublisher()
    }
}
