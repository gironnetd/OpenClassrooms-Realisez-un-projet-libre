...
public class PresentationRepositoryImpl: PresentationRepository {
    ...
    public func findPresentation(byIdPresentation idPresentation: Int) -> AnyPublisher<Presentation, Error> {
        presentationDao.findPresentation(byIdPresentation: idPresentation).map { presentation in presentation.asExternalModel() }.eraseToAnyPublisher()
    }
    ...
    public func findPresentation(byIdAuthor idAuthor: Int) -> AnyPublisher<Presentation, Error> {
        presentationDao.findPresentation(byIdAuthor: idAuthor).map { presentation in presentation.asExternalModel() }.eraseToAnyPublisher()
    }
    ...
    public func findPresentation(byIdBook idBook: Int) -> AnyPublisher<Presentation, Error> {
        presentationDao.findPresentation(byIdBook: idBook).map { presentation in presentation.asExternalModel() }.eraseToAnyPublisher()
    }
    ...
    public func findPresentation(byIdMovement idMovement: Int) -> AnyPublisher<Presentation, Error> {
        presentationDao.findPresentation(byIdMovement: idMovement).map { presentation in presentation.asExternalModel() }.eraseToAnyPublisher()
    }
    ...
    public func findAllPresentations() -> AnyPublisher<[Presentation], Error> {
        presentationDao.findAllPresentations().map { presentations in
