        ...
        describe("Cached user") {
            context("Mapped to external model") {
                it("Value is equal") {
                    ...
                    expect { externalModel.uid }.to(equal(cachedUser.uid))
                    ...
                    expect { externalModel.phoneNumber }.to(equal(cachedUser.phoneNumber))
        ...
        describe("Cached quote") {
            context("Mapped to external model") {
                it("Value is equal") {
                    ...
                    expect { externalModel.idAuthor }.to(equal(cachedQuote.idAuthor))
                    expect { externalModel.idBook }.to(equal(cachedQuote.idBook))
        ...
        describe("Cached theme") {
            context("Mapped to external model") {
                it("Value is equal") {
                    ...
                    expect { externalModel.themes }.to(equal(cachedTheme.themes.toArray().map { $0.asExternalModel() }))
        ...
        describe("Cached url") {
            context("Mapped to external model") {
                it("Value is equal") {
                    ...
                    expect { externalModel.sourceType }.to(equal(cachedUrl.sourceType))
